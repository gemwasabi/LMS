...
<div class="main-content">
    ...
    <div class="container mt-2">
        <div class="row">
            <form action="<?= ROOT ?>/klasat/perditeso/<?= $klasa['id'] ?>" method="POST" class="user-form">
                <div class="user-details">
                    ...
                    <div class="form-field">
                        ...
                        <textarea id="pershkrimi" name="pershkrimi" class="input" rows="5"
                            placeholder="Përshkrimi i Klasës"><?= $klasa['pershkrimi'] ?></textarea>
                    ...
                    <div class="form-field">
                        ...
                        <select name="profesori" class="input">
                            <?php foreach ($profesorat as $p): ?>
                                <option value="<?= $p['id'] ?>" <?= ($p['id'] == $klasa['profesori_id']) ? 'selected' : '' ?>>
                                    <?= $p['emri'] . ' ' . $p['mbiemri'] ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
