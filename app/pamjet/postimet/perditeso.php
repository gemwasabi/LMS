...
<div class="main-content">
    ...
    <div class="container mt-2">
        <div class="row">
            <form action="<?= ROOT ?>/postimet/perditeso/<?= $postimi['id'] ?>" method="POST" class="user-form">
                <div class="user-details">
                        ...
                        <select name="klasa" class="input">
                            <?php if ($klasat): ?>
                                <?php foreach ($klasat as $k): ?>
                                    <option value="<?= $k['id'] ?>" <?= ($k['id'] == $postimi['klasa_id']) ? 'selected' : '' ?>>
                                        <?= $k['emri'] ?>
                                    </option>
                                <?php endforeach; ?>
                            <?php endif; ?>
                    ...
                    <div class="form-field">
                        ...
                        <input type="text" class="input" placeholder="Titulli" id="titulli"
                            value="<?= $postimi['titulli'] ?>" name="titulli">
                        <div class="error-message" id="titulli-error"></div>
                    </div>
                    <div class="form-field">
                        <label for="pershkrimi">Përshkrimi</label>
                        <textarea name="pershkrimi" class="input" rows="5" id="pershkrimi" 
                            placeholder="Përshkrimi"><?= $postimi['permbajtja'] ?></textarea>
